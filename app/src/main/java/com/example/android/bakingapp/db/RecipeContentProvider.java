...
public class RecipeContentProvider extends ContentProvider {
    ...
    public static final int LISTS = 1000;
    public static final int LIST_WITH_ID = 1001;

    public static final int INGREDIENT = 2000;
    public static final int INGREDIENT_WITH_ID = 2001;
    public static final int INGREDIENT_BY_RECIPE = 2002;
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        if (result > 0) Objects.requireNonNull(getContext()).getContentResolver().notifyChange(uri, null);
